...
#include <memory>
#include "game/controllers/OnlineController.h"
...
namespace TankTrouble
{
        ...
        joinedRoomId(0)
    {
        ...
        newRoomBtn.set_label("Create Room");
        newRoomBtn.signal_clicked().connect(sigc::mem_fun(*this, &GameLobby::onCreateRoom));
        put(newRoomBtn, 630, 20);
        capOption1.set_label("2 Players");
        capOption2.set_label("3 Players");
        capOption3.set_label("4 Players");
    ...
    void GameLobby::getUserInfo()
    {
        ...
        char text[100] = {0};
        sprintf(text, "Nickname: %s       High Score: %u",
